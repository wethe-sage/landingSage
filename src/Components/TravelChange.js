...
const TravelChange = () => {
  ...
  return (
    <div className='bg-gray-100 py-10 px-4'>
      <h1 onMouseEnter={textEnter} onMouseLeave={textLeave}   className=" heading text-[40px] text-center font-bold md:text-center text-[#164154] md:text-[55px] md:font-bold mt-4 md:mt-[20px] md:pb-[10px] mb-6">
