  ...
  return (
    <div> 
      ...
      <div className='text-center'>
        <h1 className='heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#164154] md:mt-[30px]'>Meet The SAGES</h1>
      </div>
      <div className='mx-4 sm:mx-8 mt-4 sm:mt-8 mb-8 sm:mb-16 md:mb-32 lg:mb-64'>
